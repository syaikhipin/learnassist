...
@section('content')
    ...
    <form novalidate="novalidate" method="post" action="{{$base_url}}/super-admin/save-post-content" id="form-document"
        ...
        <div class="card">
            <div class="card-body">
                ...
                <textarea id="app-editor-content" name="content"
                          class="d-none">{!! app_clean_html_content($post->content) !!}</textarea>
